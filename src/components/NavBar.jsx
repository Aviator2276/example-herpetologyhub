    ...
    <NavigationMenu className="z-5 ">
      <NavigationMenuList>
        <NavigationMenuItem className="sm:block hidden">
          <NavigationMenuTrigger>Herpetology Hub</NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem className="sm:block hidden">
          ...
          <NavigationMenuContent>
            <ul className="grid w-[600px] gap-3 p-2 lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-4">
                <NavigationMenuLink asChild>
                  <a
                    className="flex h-full w-full select-none flex-col justify-end rounded-base p-6 no-underline outline-hidden"
                    href="https://herpetologyhub.com/games.html"
                  >
                    <div className="mb-2 mt-4 text-lg font-heading">
                      Explore the Herpetological World Through Play!
                    </div>
                    <p className="text-sm font-base leading-tight">
                      Explore the Herpetological World Through Play! Dive into
                      our collection of interactive games designed to test your
                      knowledge and deepen your understanding of amphibians and
                      reptiles.
                    </p>
                  </a>
                </NavigationMenuLink>
              ...
              <ListItem
                href="https://herpetologyhub.com/crossword.html"
                title="Crossword"
              >
                Test your knowledge with clues about snakes, frogs, lizards, and
                more!
              </ListItem>
              <ListItem
                href="https://herpetologyhub.com/wordsearch.html"
                title="Wordsearch"
              >
              ...
              <ListItem
                href="https://herpetologyhub.com/match.html"
                title="Matching Games"
              >
                Match reptiles to another in order.
              </ListItem>
              <ListItem
                href="https://herpetologyhub.com/trivia.html"
                title="Trivia"
              >
                How much do you know about herpetology? Play our trivia to find
                out!
              </ListItem>
            </ul>
          </NavigationMenuContent>
